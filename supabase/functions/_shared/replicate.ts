...
export const MODELS: Record<string, string> = {
  ...
  'runway-gen-4.5-img': 'runwayml/gen-4.5',
  ...
  'flux-img2img': 'black-forest-labs/flux-2-pro', // legacy alias
  'nano-banana-pro': 'google/nano-banana-pro',
  'nano-banana-2': 'google/nano-banana-2',
  'seedream-4.5': 'bytedance/seedream-4.5',
  'seedream-5-lite': 'bytedance/seedream-5-lite',
...
export const resolutionMap: Record<string, Record<string, [number, number]>> = {
  '480p': { '16:9': [854, 480], '9:16': [480, 854], '1:1': [480, 480], '4:3': [640, 480], '3:4': [480, 640], '21:9': [992, 432], '9:21': [432, 992] },
  '576p': { '16:9': [1024, 576], '9:16': [576, 1024], '1:1': [576, 576], '4:3': [768, 576], '3:4': [576, 768], '21:9': [1344, 576], '9:21': [576, 1344] },
  '720p': { '16:9': [1280, 720], '9:16': [720, 1280], '1:1': [720, 720], '4:3': [960, 720], '3:4': [720, 960], '21:9': [1470, 630], '9:21': [630, 1470] },
  '768p': { '16:9': [1366, 768], '9:16': [768, 1366], '1:1': [768, 768], '4:3': [1024, 768], '3:4': [768, 1024], '21:9': [1792, 768], '9:21': [768, 1792] },
  '1080p': { '16:9': [1920, 1080], '9:16': [1080, 1920], '1:1': [1080, 1080], '4:3': [1440, 1080], '3:4': [1080, 1440], '21:9': [2520, 1080], '9:21': [1080, 2520] },
  '4k': { '16:9': [3840, 2160], '9:16': [2160, 3840], '1:1': [2160, 2160], '4:3': [2880, 2160], '3:4': [2160, 2880], '21:9': [5040, 2160], '9:21': [2160, 5040] },
}
