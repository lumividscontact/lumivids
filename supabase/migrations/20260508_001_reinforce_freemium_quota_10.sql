-- =============================================
-- Reinforce freemium daily quota = 10 credits.
--
-- Why:
-- Some environments may still be running older freemium
-- function definitions with quota=20. This migration is
-- a safe idempotent guard that reapplies the current
-- expected behavior (quota=10, admin bypass).
-- =============================================

-- Existing functions may have incompatible signatures in some environments.
